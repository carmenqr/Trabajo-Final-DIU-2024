...
Durante la asignatura de Diseño de Interfaces de Usuario, se llevaron a cabo diversas prácticas que permitieron aplicar de manera práctica los conceptos aprendidos en clase. A continuación, se resumen algunas de las prácticas más destacables:
  ...
  **4.	Evaluación de Accesibilidad:**
  Se utilizó una combinación de herramientas automáticas y simuladores de discapacidad para evaluar la accesibilidad de los diseños. Esta evaluación permitió identificar y corregir problemas de accesibilidad, asegurando que las interfaces fueran inclusivas y utilizables por todas las personas, independientemente de sus capacidades.
  
  **5.	Iteración y Mejora Continua:**
  Se adoptó un enfoque iterativo en el diseño, con ciclos de diseño, prueba y refinamiento. Este enfoque aseguró que las interfaces se mejoraran continuamente con base en los comentarios de los usuarios y las pruebas de usabilidad.
...
|----------|-----------|------------|----------------------|------------|-----------------|------|-----------|
| Julia    | M/34      | Profesora universitaria | Alta                 | Desktop        |  Búsqueda de recursos educativos y materiales de investigación        | A    | 82,5        |
| Mario     | H/28      | Investigador Biomédico   | Media                 | Laptop    | Acceso a publicaciones científicas y contacto con otros investigadores     | A    | 55      |
...
El trabajo realizado en este estudio de evaluación y comparación de las interfaces y experiencias de usuario de los sitios web del Centro de Investigación Biomédica (CIBM) de la Universidad de Granada y el Instituto de Biomedicina de Sevilla (IBiS) ha sido integral y detallado, ofreciendo una visión profunda de la usabilidad y la accesibilidad de ambos sitios desde diversas perspectivas.

Se han aplicado metodologías de diseño centrado en el usuario (DCU) y técnicas de experiencia de usuario (UX) para realizar una evaluación objetiva y justificada, utilizando criterios cuantificables y técnicas probadas en el campo del diseño de interfaces y UX. Desde el análisis del diseño visual y la estructura de los sitios web hasta la evaluación de la adaptabilidad a diferentes dispositivos y la experiencia de usuario de usuarios representativos, este estudio ha abordado de manera exhaustiva cada aspecto crucial para comprender la efectividad y la satisfacción del usuario en la interacción con los sitios web.

Los aprendizajes adquiridos a lo largo de este estudio son significativos. Se ha destacado la importancia de considerar una variedad de perfiles de usuarios al evaluar la usabilidad de un sitio web, así como la necesidad de personalizar el enfoque de evaluación para abordar las necesidades específicas de cada grupo de usuarios. Además, se ha demostrado la utilidad de las comparativas A/B testing para identificar las fortalezas y debilidades de diferentes sitios web en términos de usabilidad percibida por los usuarios.

La inclusión de propuestas de mejora fundamentadas en los hallazgos del análisis ha sido un paso crucial para garantizar que las recomendaciones sean prácticas y orientadas a soluciones concretas. Esto refleja un enfoque proactivo hacia la mejora continua de la experiencia del usuario y la accesibilidad de los sitios web evaluados.

Como conclusión final, este estudio no solo ha proporcionado una evaluación detallada de los sitios web del CIBM y el IBiS, sino que también ha ofrecido insights valiosos sobre las mejores prácticas en el diseño de interfaces y la experiencia del usuario, así como lecciones importantes sobre la importancia de adoptar un enfoque centrado en el usuario en el desarrollo y la evaluación de sitios web.
